    ...
    return (
      ...
      >
        ...
        <div style={{
          ...
          boxShadow: hovered
            ? '0 18px 36px rgba(138,18,40,0.22), 0 4px 10px rgba(0,0,0,0.08)'
          ...
          <div style={{
            ...
            <button onClick={play} style={{
              ...
              <span className="material-symbols-outlined" style={{
                color: '#5C0F1F', fontSize: 24, fontVariationSettings: "'FILL' 1",
              }}>play_arrow</span>
            </button>
          </div>
          {/* Duration */}
    ...
    return (
      <div
        ...
        style={{
          ...
          boxShadow: hovered ? '0 4px 16px rgba(138,18,40,0.09)' : 'none',
      ...
      >
        ...
        <button onClick={play} style={{
          ...
          background: hovered ? '#5C0F1F' : '#FDF4F2',
          cursor: 'pointer', display: 'flex', alignItems: 'center',
          justifyContent: 'center', flexShrink: 0,
          transition: 'background 0.18s ease',
        }}>
          <span className="material-symbols-outlined" style={{
            fontSize: 18, color: hovered ? '#fff' : '#5C0F1F',
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'linear-gradient(135deg,#8A1228,#5C0F1F)',
        boxShadow: hovered
          ? '0 24px 48px rgba(138,18,40,0.28)'
          : '0 8px 24px rgba(138,18,40,0.16)',
      ...
      <div style={{
        ...
        {podcast.category && (
          <span style={{
            ...
            background: '#B8964A', color: '#3d2900',
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={play} style={{
            ...
            background: '#5C0F1F', color: '#fff', border: 'none',
